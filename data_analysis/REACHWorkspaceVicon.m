...
N = readmatrix('workspace.csv','Range','C6:BY162437');
...
% Read two endpoints
final_time_step = 162425;
endpoint1 = N(1:final_time_step, 70:72);
endpoint2 = N(1:final_time_step, 73:75);
...
figure(1)
scatter3(endpoint1(:, 1),endpoint1(:, 2),endpoint1(:, 3), 100, 'MarkerEdgeColor','k','MarkerFaceColor',[0 .75 .75])
hold on
scatter3(endpoint2(:, 1),endpoint2(:, 2),endpoint2(:, 3), 100, 'MarkerEdgeColor','k','MarkerFaceColor',[0 .75 .75])
hold on


figure(2)
for i = 1:100:final_time_step
    scatter3(endpoint1(i, 1),endpoint1(i, 2),endpoint1(i, 3), 550, 'MarkerEdgeColor','k','MarkerFaceColor',[0 .75 .75])
    hold on
    scatter3(endpoint2(i, 1),endpoint2(i, 2),endpoint2(i, 3), 550, 'MarkerEdgeColor','k','MarkerFaceColor',[0 .75 .75])
    hold on
end
