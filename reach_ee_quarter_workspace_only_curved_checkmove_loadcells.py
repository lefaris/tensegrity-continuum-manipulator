...
spd = 144000
acc = 144000
motmov = 11520 # Prev command was 46080

# Set the steps per longitudinal path
longitudinal_path = 5

# This value will control the quantity of additional slack in the two tendons to
# the left and right of the primary driving tendon, e.g. if side_tendons_slack = 4,
# then an additional "minus" command will be sent to the left and right tendons
# every 4 steps.  This should reduce the overall tension built up in the system
side_tendons_slack = 4
